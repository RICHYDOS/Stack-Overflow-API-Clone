...
const getOne = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let comment;
    comment = yield models_1.default.Q_comments.findOne({ where: { id: req.params.id } });
    if (comment === null) {
        res.status(400);
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (comment === null) {
        ...
        comment = yield models_1.default.Q_comments.update({ comment: title }, {
            where: {
                id: req.params.id
            }
        });
...
const destroy = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (comment === null) {
        ...
        yield models_1.default.Q_comments.destroy({ where: { id: req.params.id } });
